...
<?php 
	...
	$sql = "INSERT INTO det_property (property_name, property_type, property_sub_type, flat_no, address, landmark, location, state_id, city_id, pincode, buildup_area, age_of_property,carpet_area,covered_parking,open_parking,elec_meter_no,status,creation_date,last_modification_date,added_by,Update_by) VALUES ('$v_p_name','$v_p_type','$v_p_sub_type','$v_flatno','$v_address','$v_landmark','$v_location','$v_state','$v_city','$v_pincode','$v_buildup_area','$v_carpet_area','$v_age_of_property','$v_covered_parking','$v_open_parking','$v_elecMeter','$v_status',CURRENT_TIMESTAMP(),'$v_last_modification_date','$v_added_by','$v_update_by')";
