...
<?php
    ...
    $v_UpdatedBy='';
     ...
     // <------------------- Insert Query------------------------->
	$sql = "INSERT INTO det_agreement (property_id, tenant_id, agreement_date, agreement_from, agreement_to, possession_date, locking_period, deposit_amount, deposit_date, rent_per_month, gst_applicable, gst_amount, maintainance_charges, charges_paidby_tenant, manager_id,brokerage,loading_charges,amc_tenant,remark, status, creation_date, last_modification_date, Added_by, Updated_by) VALUES ('$v_propertyName', '$v_tenant_id', '$v_agreementDate','$v_agreementFrom', '$v_agreementTo', '$v_possessionDate','$v_lockingPeriod', '$v_depositAmount', '$v_depositDate', '$v_baseRent', '$v_gstStatus', '$v_gstAmt','$v_maintainceCharges', '$v_charges', 
