...
function ModalPopupWindow() {
    ...
    function ResizePopUp(height, width) {
        ...
        divFrameParent.style.left = left + 120 + "px";
    ...
    this.DoDragging = function(e, undefined) {
        ...
        try {
            ...
            __div_frame_parent.style.left = left + 120 + "px";
        } catch (ex) {}
    }
