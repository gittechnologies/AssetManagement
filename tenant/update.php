<?php
 session_start();
    ...
    $sql = "UPDATE det_tenant SET tenant_name='$v_tenant_name', address='$v_address',state_id='$v_state', city_id='$v_city', pincode='$v_pincode',contact_number='$v_contact_number', email_id='$v_email',pan_no='$v_pan_no', occupation='$v_occupation', gst_status='$v_status_gst', gst_no='$v_gst_no',company_name='$v_company', company_email='$v_company_email', updated_by='$v_UpdatedBy', power_of_attorney ='$v_power_of_attorney',last_modification_date=CURRENT_TIMESTAMP() WHERE tenant_id='$v_tenant_id' ";
