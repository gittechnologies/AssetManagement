...
session_start();
	...
	$sql = "INSERT INTO det_tenant (tenant_name, gender, dob, address, state_id, city_id, pincode, contact_number, email_id, pan_no,occupation, gst_status, gst_no, company_name, company_email,	tenantType, status,power_of_attorney, creation_date, last_modification_date, Added_by,Updated_by) VALUES ('$v_tenant_name','$v_gender','$v_dob','$v_address','$v_state','$v_city','$v_pincode','$v_contact_number','$v_email','$v_pan_no','$v_occupation','$v_status_gst','$v_gst','$v_company','$v_company_email','$v_tenant_type','$v_status','$v_power_of_attorney',CURRENT_TIMESTAMP(),'$v_last_modification_date','$v_AddedBy','$v_UpdatedBy')";
